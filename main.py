...
for c in cnts:
    ...
    cv2.imwrite('Image_{}.jpg'.format(ROI_number), ROI)
...
import glob
import os
dir_name = '/Users/russmckay/PycharmProjects/analogue_meter_read/'

# Get list of files in a directory
list_of_files = filter( os.path.isfile,
                        glob.glob(  dir_name + 'Image*.jpg') )
...
DIR_NAME_IMAGES = '/Users/russmckay/PycharmProjects/analogue_meter_read'
...
img_list = glob.glob(max_file)             # get list with jpg images
...
for img_name in img_list:
    ...
    if result > 30:
        wo = ("Work order required")
    print("\tDigital conversion from analogue read: ", result, "deg C  ", wo)
